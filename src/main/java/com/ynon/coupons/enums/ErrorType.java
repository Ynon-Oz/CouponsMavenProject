...
public enum ErrorType {
	...
	INVALID_USER(602, "Username allready exist",false),
	INVALID_COMPANY(603, "Company allready exist",false),
	...
	COSTUMER_EXIST(607,"Costumer detailes allready exist",false),
	...
	USER_ALLREADY_EXIST(617,"User allready exist",false), 
	...
	PURCHASE_FAILED_COUPON_EXPIRED(622,"expired coupon is tring to be purchase",true), 
	PURCHASE_FAILED_COUPON_OUT_OF_STOKE(623,"coupon out of stock",false),
	COUPON_EXIST(624,"Coupon add failed - coupon alredy exist",true), 
	...
	COUPON_TITLE_IS_ALLREADY_EXISTS(632,"Coupon title is allready exists, choose a differente title",false);
	...
	private ErrorType(int errorNumber, String errorMasage, boolean stackTracePrint) {
		this.errorNumber = errorNumber;
		this.errorMessage = errorMasage;

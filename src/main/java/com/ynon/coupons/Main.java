...
//		======================================
		...
		Date endDate = new Date(121, 11, 31);
		// Creating Coupons
		...
		// Creating Users
		User u1 = new User("admin@admin.com", "123456", null, UserType.ADMIN);
		User u2 = new User("company@company.com", "123456", comp1, UserType.COMPANY);
